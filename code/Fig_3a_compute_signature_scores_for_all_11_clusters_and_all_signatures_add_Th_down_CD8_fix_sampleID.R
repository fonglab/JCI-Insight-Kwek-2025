...
#### blood & tumor, CD8  all cell types ####

# input_data <- "/Users/hai/Documents/workstation/bladder_blood_analysis/metadata/CD4_matrix_and_metadata/adata_Blood_and_tumor_CD8_all_cell_types_raw_matrix.rds"
# MyData <- readRDS(input_data)
p2 <- read.csv("/Users/hai/Documents/workstation/bladder_blood_analysis/metadata/CD4_matrix_and_metadata/adata_Blood_and_tumor_CD8_all_cell_types_metadata.csv",header = T, row.names = 1)
...
p2 <- df
write.csv(p2, file = "/Users/hai/Documents/workstation/bladder_blood_analysis/metadata/CD4_matrix_and_metadata/adata_Blood_and_tumor_CD8_all_cell_types_metadata_fix_sampleID.csv", row.names = FALSE)
# p2 <- read.csv("/Users/hai/Documents/workstation/bladder_blood_analysis/metadata/CD4_matrix_and_metadata/adata_Blood_and_tumor_CD8_all_cell_types_metadata_fix_sampleID.csv",header = T)



# input_data <- "/Users/hai/Documents/workstation/bladder_blood_analysis/metadata/CD4_matrix_and_metadata/adata_Blood_and_tumor_CD8_all_cell_types_raw_matrix.csv"
# MyData <- read.csv(input_data,header = T, row.names = 1)
MyData <- readRDS("adata_Blood_and_tumor_CD8_all_cell_types_raw_matrix_backup.rds")

# saveRDS(MyData, "adata_Blood_and_tumor_CD8_all_cell_types_raw_matrix_backup.rds")
...
for (gene_list_name in gene_list_name_list) {
  ...
  pdf(paste0(gene_list_name, " gene signature barplot panels on data CD8 all cell types comparing blood vs tumor, share vs non-shared.pdf"))
        ...
        print(barplot1)
              print(barplot2)
                    ...
                    print(barplot3_1)
                          print(barplot4)
  dev.off()
  write.csv(p2, paste0(gene_list_name, " gene signature barplot panels on data CD8 all cell types comparing blood vs tumor, share vs non-shared.csv"))
